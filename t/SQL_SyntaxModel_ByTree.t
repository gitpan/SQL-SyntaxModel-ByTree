...
# `make test'. After `make install' it should work as `perl SQL_SyntaxModel_ByTree.t'
...
use SQL::SyntaxModel::ByTree 0.30;
use SQL::SyntaxModel::ByTree::L::en 0.05;
$loaded = 1;
print "ok 1\n";
use strict;
use warnings;
...
eval {
	...
	result( ref($model) eq 'SQL::SyntaxModel::ByTree::Container', "creation of all objects" );
